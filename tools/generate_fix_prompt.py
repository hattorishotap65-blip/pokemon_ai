...
def _build_fix_prompt(candidate: dict) -> str:
    ...
    lines.extend([
        ...
        "```bash",
        "# Run simulation",
        "wsl -d Ubuntu -e bash -c \"cd /mnt/c/Users/shclo/projects/pokemon_card_ai && PYTHONPATH=... python3 experiments/run_matches_real.py --n 50 --start-game NNNN\"",
        "",
        "# Copy logs to inbox",
        "Copy-Item logs/game_gNNNN*.jsonl battle_logs/inbox/",
        "",
